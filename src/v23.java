...
public class v23 extends JFrame
{
	public JLabel EM=new JLabel("***MENU Libros***");
	public JLabel EM1=new JLabel("Ingrese ID a modificar");
	...
	public JButton BMlaceptar2=new JButton("Guardar");
	public v23()
	{
		super("***MENU Modificar Libros***");
